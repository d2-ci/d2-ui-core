...
var Action = {
    ...
    create: function create() {
        ...
        var subject = (0, _assign2.default)(function () {
            ...
            return _Observable.Observable.fromPromise(new _promise2.default(function (resolve, reject) {
                subject.next({
        ...
        }, _Observable.Observable.prototype, _Subject.Subject.prototype);

        Object.defineProperty(subject, 'id', { value: (0, _symbol2.default)(name) });

        _Subject.Subject.call(subject);
