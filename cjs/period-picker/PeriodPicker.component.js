...
var PeriodPicker = function (_React$Component) {
    ...
    (0, _createClass3.default)(PeriodPicker, [{
        ...
        value: function getPeriod() {
            var date = this.state.year && this.state.week && (0, _helpers.getFirstDateOfWeek)(this.state.year, this.state.week);
        ...
        value: function renderOptionPicker(name, options) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_MenuItem2.default, { key: '', value: this.state[name], primaryText: '\xA0' }),
...
PeriodPicker.propTypes = {
    periodType: _propTypes2.default.oneOf(['Daily', 'Weekly', 'WeeklyWednesday', 'WeeklyThursday', 'WeeklySaturday', 'WeeklySunday', 'Monthly', 'BiMonthly', 'Quarterly', 'SixMonthly', 'SixMonthlyApril', 'Yearly', 'FinancialApril', 'FinancialJuly', 'FinancialOct']).isRequired,
